...
@register_env("PutSpoonOnTableClothInScene-v0", max_episode_steps=80)
...
@register_env("PutCarrotOnPlateInScene-v0", max_episode_steps=80)
...
@register_env("StackGreenCubeOnYellowCubeInScene-v0", max_episode_steps=80)
...
@register_env("StackGreenCubeOnYellowCubeBakedTexInScene-v0", max_episode_steps=80)
