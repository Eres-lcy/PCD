...
ENVIRONMENT_MAP = {
    ...
    "google_robot_pick_coke_can_drawer_variant": (
        "GraspSingleOpenedCokeCanDrawerVariantInScene-v0",
        {},
    ),
    "google_robot_pick_coke_can_light_variant": (
        "GraspSingleOpenedCokeCanLightVariantInScene-v0",
        {},
    ),
    "google_robot_pick_coke_can_table_paper_variant": (
        "GraspSingleOpenedCokeCanTablePaperVariantInScene-v0",
        {},
    ),
    "google_robot_pick_coke_can_table_stone_variant": (
        "GraspSingleOpenedCokeCanTableStoneVariantInScene-v0",
        {},
    ),
}
